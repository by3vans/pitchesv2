...
export function UpgradeEmail({ name, plan }: Props) {
  return (
    <Html>
      <Head />
        ...
        >
          ...
          <Section style={{ padding: '32px 40px' }}>
            ...
            <Text style={{ fontSize: 15, color: brand.textMuted, lineHeight: 1.6 }}>
              Your upgrade is confirmed. All {plan} features are now available in your account.
            </Text>
            <Button
            ...
            <Text style={{ fontSize: 13, color: brand.textLight }}>
              Questions? Reply to this email or reach us at {brand.email}
            </Text>
          </Section>
        </Container>
      </Body>
